 ...
 * src/vs/workbench/contrib/browserView/test/common/browserSearch.test.ts
 * (at 1.134.0-1325-gaa7291eba7d). Changes: uses node:test + node:assert
 * instead of the monorepo's mocha harness, and the disposable-leak check
 * was dropped (nothing here allocates disposables).
 */
