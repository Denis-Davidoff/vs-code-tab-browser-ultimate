/*---------------------------------------------------------------------------------------------
 *  The `externalUriOpener` proposed api. The editor only grants it to its own bundled
 *  extensions, so `extension.ts` guards the call; this declaration is here to type check it.
 *--------------------------------------------------------------------------------------------*/
