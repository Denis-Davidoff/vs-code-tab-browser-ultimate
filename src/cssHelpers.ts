...
/*
 * Copied verbatim from microsoft/vscode:
 * src/vs/platform/browserView/common/cssHelpers.ts (at 1.134.0-1325-gaa7291eba7d).
 * Unmodified — it has no imports at all. This is what makes our element context
 * byte-comparable with the built-in browser's own "Add Element to Chat" output.
 * Re-sync deliberately rather than editing in place.
 */
