 ...
 * src/vs/platform/browserView/test/common/cssHelpers.test.ts (at 1.134.0-1325-gaa7291eba7d).
 * Only change: node:test + node:assert in place of the monorepo's mocha harness.
 * This is the specification for cssHelpers.ts — keep them in sync together.
 */

import * as assert from 'node:assert';
import { suite, test } from 'node:test';
import { collapseToShorthands, formatMatchedStyles, type IMatchedStyles } from './cssHelpers.ts';
